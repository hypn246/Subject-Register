        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousCourseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursePrevious", x => new { x.CourseId, x.PreviousCourseId });
                    table.ForeignKey(
                        name: "FK_CoursePrevious_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CoursePrevious_Courses_PreviousCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    RequirementCourseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseRequirement", x => new { x.CourseId, x.RequirementCourseId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseRequirement_Courses_RequirementCourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursePrevious_PreviousCourseId",
                table: "CoursePrevious",
                column: "PreviousCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseRequirement_RequirementCourseId",
